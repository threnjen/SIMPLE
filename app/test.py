...
def cli() -> None:
    ...
    parser.add_argument(
        "--agents", "-a", nargs="+", type=str, default=["human", "human"], help="Player Agents (human, ppo version)"
    )
    parser.add_argument(
        "--best",
        "-b",
    ...
    parser.add_argument("--debug", "-d", action="store_true", default=False, help="Show logs to debug level")
    parser.add_argument("--verbose", "-v", action="store_true", default=False, help="Show observation on debug logging")
    parser.add_argument(
        "--manual", "-m", action="store_true", default=False, help="Manual update of the game state on step"
    )
    parser.add_argument(
        "--randomise_players", "-r", action="store_true", default=False, help="Randomise the player order"
    )
    parser.add_argument(
        "--recommend", "-re", action="store_true", default=False, help="Make recommendations on humans turns"
    )
    parser.add_argument(
